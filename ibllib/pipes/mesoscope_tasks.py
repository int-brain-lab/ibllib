...
class MesoscopeFOV(base_tasks.MesoscopeTask):
    ...
    def _run(self):
        ...
        return list(self.session_path.glob('alf/FOV_*/mpciMeanImage.brainLocationIds*')) + \
            list(self.session_path.glob('alf/FOV_*/mpciMeanImage.mlapdv*'))

    def register_fov(self):
        """Create FOV on Alyx"""
