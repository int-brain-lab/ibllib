...
class BrainRegions(_BrainRegions):
    ...
    def __init__(self):
        ...
        self.mappings = {
            ...
            'Nick': self._mapping_from_regions_list(NICK),
            'Mayo': self._mapping_from_regions_list(MAYO),
        }
    ...
    def _mapping_from_regions_list(self, new_map):
        ...
        mapind = np.zeros_like(self.id)  # non assigned regions are void
