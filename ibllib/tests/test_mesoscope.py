...
class TestMesoscopeFOV(unittest.TestCase):
    ...
    def test_reproject(self):
        ...
        from pathlib import Path
        import tifffile
        ref_img_path = Path(r'C:\Users\Work\Downloads\ONE\alyx.internationalbrainlab.org\cortexlab\Subjects\SP058\2024-08-01\001\raw_imaging_data_02\reference\referenceImage.stack.tif')
