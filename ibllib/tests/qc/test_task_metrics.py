...
class TestTaskQCWithCustomCriteria(TaskQCTestData):
    ...
    def setUp(self):
        ...
        note_text = {'title': note_title, 'criteria': {'default': {'WARNING': 1, 'FAIL': 0.5}}}
    ...
    def test_compute(self):
        ...
        metrics['_task_stimOff_itiIn_delays'], passed['_task_stimOff_itiIn_delays'] = qcmetrics.check_stimOff_itiIn_delays(
            self.data
        )

        metrics['_task_stimOn_delays'], passed['_task_stimOn_delays'] = qcmetrics.check_stimOff_itiIn_delays(self.data)
