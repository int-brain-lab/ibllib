...
This script uploads a Histology Session to IBL Alyx including sample ID, sample Reception and Imaging dates, and the affine matrix.  The tilt, yaw, rol, dv_scale, ap_scale, ml_scale values are computed from the affine matrix.
...
affine_matrix : str
    4x4 Affine Transformation Matrix mapping sample2ARA/, given in format "0.912838 0.038861 0.142005 -0.054963 0.820837 0.034729 -0.135135 -0.065278 0.929171 -18.357938 -19.875191 -5.734609"
...
if len(sample_imaging_date) != 10 or sample_imaging_date[2:3] != "-" or sample_imaging_date[5:6] != "-":
    print("sample_imaging_date not in correct format")
    sys.exit()
    
if len(sample_reception_date) != 10 or sample_reception_date[2:3] != "-" or sample_reception_date[5:6] != "-":
