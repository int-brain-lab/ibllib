...
tscale = np.array([-0.695, -0.685, -0.675, -0.665, -0.655, -0.645, -0.635, -0.625,
       -0.615, -0.605, -0.595, -0.585, -0.575, -0.565, -0.555, -0.545,
       -0.535, -0.525, -0.515, -0.505, -0.495, -0.485, -0.475, -0.465,
       -0.455, -0.445, -0.435, -0.425, -0.415, -0.405, -0.395, -0.385,
       -0.375, -0.365, -0.355, -0.345, -0.335, -0.325, -0.315, -0.305,
       -0.295, -0.285, -0.275, -0.265, -0.255, -0.245, -0.235, -0.225,
...
for region in regions:
    ...
    all_region_data = pickle.load(open(folder + region + "_save_feedback.p", "rb"))
    ...
    ax1.set_xlabel('Time around feedback onset (s)', fontsize=24)
    ...
    plt.savefig('figures/dpca/feedback_time_all_neurons' + '_' + region + '.png')
    plt.close()
    continue
