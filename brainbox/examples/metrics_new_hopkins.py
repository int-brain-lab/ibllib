...
def gen_metrics_labels(eid,probe_name):
    ...
    try:
        ...
        refpvioldf.to_csv(Path(alf_probe_dir, 'RefPViol.csv'),
                                sep=',', header=['RefPViol'])
    ...
    try:
        ...
        noisecutoffdf.to_csv(Path(alf_probe_dir, 'NoiseCutoff.csv'),
    ...
    try:
        ...
        labeldf.to_csv(Path(alf_probe_dir, 'label.csv'),
                                sep=',', header=['label'])
    except Exception as err:
